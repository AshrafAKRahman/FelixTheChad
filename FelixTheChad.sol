...
contract FelixTheChad is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Felix The Chad";
    string private _symbol = "FTC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaafCB364625c2107d82D938fB7a2a6881B76080A); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x7A13A72e077481c48C16eF88aCbdFfa1dCfF46E3); // BuyBack Address
